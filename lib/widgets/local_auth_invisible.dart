...
class LocalAuthInvisible extends StatefulWidget {
  @override
  _LocalAuthInvisibleState createState() => _LocalAuthInvisibleState();
}

class _LocalAuthInvisibleState extends State<LocalAuthInvisible> {
